...
CREATE TABLE `aiot_core_users` (
  ...
  `role` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'individual' COMMENT '用户角色：individual/platform_admin/teacher/student',
...
CREATE TABLE `aiot_kb_permissions` (
  ...
  `knowledge_base_id` int(11) NOT NULL COMMENT '知识库ID',
  `user_id` int(11) DEFAULT NULL COMMENT '用户ID',
  `role` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '角色（platform_admin/teacher/student）',
...
CREATE TABLE `aiot_knowledge_bases` (
  ...
  `scope_type` enum('system','course','agent','personal') COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '作用域类型',
  `scope_id` int(11) DEFAULT NULL COMMENT '作用域ID（course_id/agent_id）',
