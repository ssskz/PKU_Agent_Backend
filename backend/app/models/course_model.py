...
class CourseTeacher(Base):
    ...
    teacher_id = Column(Integer, ForeignKey("aiot_core_users.id"), nullable=False, index=True, comment="教师ID")
    created_at = Column(DateTime, default=get_beijing_time_naive, comment="创建时间")
    deleted_at = Column(DateTime, nullable=True, comment="删除时间")
...
class CourseStudent(Base):
    ...
    course_id = Column(Integer, ForeignKey("aiot_courses.id"), nullable=False, index=True, comment="课程ID")
    student_id = Column(Integer, ForeignKey("aiot_core_users.id"), nullable=False, index=True, comment="学生ID")
...
class CourseGroup(Base):
    ...
    leader_id = Column(Integer, ForeignKey("aiot_core_users.id"), nullable=True, index=True, comment="组长ID")
