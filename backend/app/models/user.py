...
class User(Base):
    ...
    # 角色和归属
    role = Column(String(50), default='individual', nullable=False, comment='用户角色：individual/platform_admin/teacher/student')
    
    # 机构用户字段
    teacher_number = Column(String(50), nullable=True, index=True, comment='教师工号（仅教师/教师有）')
